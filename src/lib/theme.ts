...
export const COLORS = {
  primary: "#5CBDE7",
  primaryDark: "#4BA9D1",
  primaryLight: "#70ace4bf",
  primaryTransparent: "rgba(92, 189, 231, 0.5)",
  ...
  outgoingBubble: "#356F80",
  incomingBubble: "#1A272E",
  chatBackground: "#0E1417",

  accent: "#FF6B6B",
  accentSecondary: "#00B894",
};

// export const kizsaTheme: DeepPartial<Theme> = {
//   colors: {
